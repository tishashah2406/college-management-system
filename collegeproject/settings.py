...
SECRET_KEY = 'django-insecure-#+wm9mi!s^45t3evp-yq_#0(=gbr1u0nr2oowi!ihtfygh6%9w'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'myprojectdb2',        # your database name
        #'USER': 'myprojectuser',      # MySQL username
        #'PASSWORD': 'tisha@2406',     # MySQL password
        'HOST': 'localhost',
        'PORT': '3306',
        'USER': 'root',
        'PASSWORD': '',
